...
speedreading = {
    ...
    stop: function (fadetime) {
        ...
        /*var date2 = new Date();
        var passedTime = date2.getTime() - parseInt(localStorage.getItem("currenttime"));
        var noDelayTime = ((passedTime - 1000) / 1000)
        var wordCount = (speed / 60) * noDelayTime;*/
        clearInterval(timer);
        sendData();
        //alert(a + " kelime okudunuz.");
        a = 0;
    },
